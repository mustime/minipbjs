...
tape.test('convert test', function(test) {
    var name = 'convert';
    ...
    var Message = protobuf.roots[name].foo.Message;
    ...
    test.test(test.name + " - Message.fromObject", function(test) {
        ...
        test.same(msg.uint64Val, protobuf.util.Long.fromValue({ low: 1, high: 0, unsigned: true }), "should set uint64Val from a number");
        test.same(msg.uint64Repeated, [ protobuf.util.Long.fromValue({ low: 1, high: 0, unsigned: true}), protobuf.util.Long.fromValue({ low: 2, high: 0, unsigned: true }) ], "should set uint64Repeated from a number and a string");
        ...
        test.same(msg.int64Map, { a: protobuf.util.Long.fromValue({ low: 2, high: 0, unsigned: false }), b: protobuf.util.Long.fromValue({ low: 3, high: 0, unsigned: false }) }, "should set int64Map from a number and a string");
    ...
    test.test(test.name + " - Message#toJSON", function(test) {
        var msg = Message.create();
        Message.toObject = function(obj, opt) {
